...
<html class="loading" lang="es" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>Error 404| Verifica.me</title>
  ...
  <div class="row">
    ...
    <div class="col s12 center-align white">
      <img src="<?php echo base_url(); ?>assets/css/images/gallery/error-2.png" class="bg-image-404" alt="">
      <h1 class="error-code m-0">404</h1>
      <h6 class="mb-2">No se encontró la página</h6>
      <a class="btn waves-effect waves-light gradient-45deg-deep-purple-blue gradient-shadow mb-4" href="<?php echo base_url(); ?>">Volver a la principal</a>
    </div>
  </div>
</div>
        </div>
