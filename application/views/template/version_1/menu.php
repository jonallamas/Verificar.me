    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-square">
      <div class="brand-sidebar">
        <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="index.html"><img src="<?php echo base_url(); ?>assets/css/images/logo/logo-positivo.svg" alt="Verificarme Logo"/></a>
          <!-- <a class="navbar-toggler" href="#"><i class="material-icons">radio_button_checked</i></a> -->
        </h1><br>
      </div>
      <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
        <li><a class="<?php if($seccion == 'principal'){ echo 'collapsible-body active gradient-45deg-indigo-blue gradient-shadow'; } ?>" href="<?php echo base_url(); ?>panel" data-i18n=""><i class="material-icons">home</i><span>Inicio</span></a></li>
        ...
        <li><a class="<?php if($seccion == 'empresas'){ echo 'collapsible-body active gradient-45deg-indigo-blue gradient-shadow'; } ?>" href="<?php echo base_url(); ?>empresas"><i class="material-icons">business_center</i><span>Empresas</span></a></li>
        <li><a class="<?php if($seccion == 'establecimientos'){ echo 'collapsible-body active gradient-45deg-indigo-blue gradient-shadow'; } ?>" href="<?php echo base_url(); ?>establecimientos"><i class="material-icons">business</i><span>Establecimientos</span></a></li>
