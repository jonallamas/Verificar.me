    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-square">
      ...
      <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
        ...
        <li class="navigation-header"><a class="navigation-header-text">MI CUENTA </a><i class="navigation-header-icon material-icons">more_horiz</i>
        </li>
        <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="#"><i class="material-icons">settings</i><span class="menu-title" data-i18n="">Ajustes</span></a>
          <div class="collapsible-body">
            <ul class="collapsible collapsible-sub" data-collapsible="accordion">
              <li><a class="collapsible-body" href="charts-chartjs.html" data-i18n=""><i class="material-icons">radio_button_unchecked</i><span>Editar Información</span></a>
              </li>
        ...
        <li class="bold gradient-45deg-deep-orange-orange"><a class="waves-effect waves-cyan " href="suscripcion"><i class="material-icons">stars</i><span class="menu-title" data-i18n="">Suscripción</span></a>
        </li>
        ...
        <li class="bold"><a class="waves-effect waves-cyan " href="guia"><i class="material-icons">track_changes</i><span class="menu-title" data-i18n="">Cómo funciona</span><span class="badge badge pill light-blue float-right mr-10">Guía</span></a>
        </li>
        <li class="bold"><a class="waves-effect waves-cyan " href="ayuda"><i class="material-icons">import_contacts</i><span class="menu-title" data-i18n="">Documentation</span></a>
        </li>
        <li class="bold"><a class="waves-effect waves-cyan " href="ayuda"><i class="material-icons">help_outline</i><span class="menu-title" data-i18n="">Ayuda</span></a>
        </li>

        <li class="navigation-header"><a class="navigation-header-text">Legal </a><i class="navigation-header-icon material-icons">more_horiz</i>
        </li>

        <li class="bold"><a class="waves-effect waves-cyan " href="condiciones-uso"><span class="menu-title" data-i18n="">Condiciones de Uso</span></a>
        </li>
        <li class="bold"><a class="waves-effect waves-cyan " href="politica-privacidad"><span class="menu-title" data-i18n="">Política de Privacidad</span></a>
        </li>
        <li class="bold"><a class="waves-effect waves-cyan " href="terminos-condiciones"><span class="menu-title" data-i18n="">Terminos y condiciones</span></a>
        </li>
      </ul>
